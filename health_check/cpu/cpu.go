...
func CPUHealth() {
	...
	fmt.Println(style.Header.Render("-------- CPU Health Check Result --------"))
	fmt.Println(style.Container.Render(coreFrequency.ModelName))
...
func beautifyFormatted(function func(string) string, msg string, args ...any) string {
